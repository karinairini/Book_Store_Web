    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "/books", "/addBook", "/deleteBook", "/updateBook").hasAnyAuthority("ADMIN", "USER");
                    authConfig.requestMatchers(HttpMethod.GET, "/regularUsers", "/addUser", "/deleteUser").hasAuthority("ADMIN");
